"""exp_046_large_tt.py: Expanded TT Hash Table (131,072 entries = 8x size) for increased hit rate and faster Search. (Reference / Non-submission experimental code)"""
...
class MyPlayer(BasePlayer):
    ...
    def _log_profile(self, total_time: float, is_book: bool, actual_turn: int):
        ...
        print(log_str, end="")
        log_file = "exp_046_profile_log.txt"
