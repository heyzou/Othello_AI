"""exp_045_search_breakdown.py: Detailed profiling breakdown of Search internal operations (MoveGen, ApplyMove, MoveOrder, TTHash). (Reference / Non-submission experimental code)"""
...
class MyPlayer(BasePlayer):
    ...
    def _log_profile(self, total_time: float, is_book: bool, actual_turn: int):
        ...
        print(log_str, end="")
        log_file = "exp_045_profile_log.txt"
