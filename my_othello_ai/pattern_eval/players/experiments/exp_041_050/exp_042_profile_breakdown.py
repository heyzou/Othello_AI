"""exp_042_profile_breakdown.py: Profile execution time breakdown per move."""
...
class MyPlayer(BasePlayer):
    ...
    def _legal_move_mask_bits(self, state: tuple[int, int], color: Cell) -> int:
        ...
        legal_bits = 0
        for direction in range(8):
            candidates = opponent_bits & self._shift_bits(own_bits, direction)
            for _ in range(5):
    ...
    def _log_profile(self, total_time: float, is_book: bool, actual_turn: int):
        ...
        print(log_str, end="")
        log_file = "exp_042_profile_log.txt"
